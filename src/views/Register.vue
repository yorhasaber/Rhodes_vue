<template>
  <div class="wrapper">
    ...
    <div
        style="margin: 100px auto; background-color: #bebdbd; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      <div style="margin: 20px 0; text-align: center; font-size: 24px ;color: midnightblue"><b>注 册</b></div>
